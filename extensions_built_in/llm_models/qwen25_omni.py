...
BASE_REPO = "./models/Qwen2.5-Omni-7B"
# thinker hidden size -> config/processor repo; single-file checkpoints carry no config
BASE_REPO_BY_HIDDEN = {
    3584: "./models/Qwen2.5-Omni-7B",
    2048: "./models/Qwen2.5-Omni-3B",
}
# single-file convrot8 thinker written by scripts/convert_vllm_to_comfy.py
DEFAULT_CHECKPOINT = "./models/text_encoders/qwen2_5_omni_7b_convrot8.safetensors"
