...
export const AI_TOOLKIT_UI_MODELS: ModelArch[] = [
  {
    ...
    defaults: {
      ...
      "config.process[0].model.name_or_path": [
        "./models/ace_step_1.5_ComfyUI_files/ace_step_1.5_xl_base_aio.safetensors",
        defaultNameOrPath,
      ],
    ...
    modelNotes: (
      <div className="space-y-2">
        ...
        <p>
          ...
          ）。便携版请先在“模型管理”中检查这些组件。它生成的是模型原生 Token 的近似值，因此即使
  ...
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "./models/ace_step_1.5_ComfyUI_files/ace_step_1.5_base_aio.safetensors",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
