...
export const AI_TOOLKIT_UI_MODELS: ModelArch[] = [
  {
    ...
    defaults: {
      ...
      "config.process[0].model.name_or_path": [
        "/datasets/studio/huggingface/models/ace_step_1.5_ComfyUI_files/ace_step_1.5_xl_base_aio.safetensors",
        defaultNameOrPath,
      ],
  ...
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "/datasets/studio/huggingface/models/ace_step_1.5_ComfyUI_files/ace_step_1.5_base_aio.safetensors",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
