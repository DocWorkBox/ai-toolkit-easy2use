...
# The Comfy-Org repack is the weight source; the portable build keeps the
# original model's configs and processor locally because the repack omits them.
COMFY_REPO = "Comfy-Org/Qwen-Image-2.1"
BASE_REPO = "./models/Qwen-Image-2.1"
