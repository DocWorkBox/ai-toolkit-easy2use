...
export const AI_TOOLKIT_UI_MODELS: ModelArch[] = [
  {
    ...
    defaults: {
      ...
      "config.process[0].model.name_or_path": [
        "/datasets/studio/huggingface/models/Anima-Base-v1.0-Diffusers",
        defaultNameOrPath,
      ],
  ...
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "/datasets/ai-toolkit/models/FLUX.1-dev",
        defaultNameOrPath,
      ],
  ...
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "/datasets/ai-toolkit/models/FLUX.1-Kontext-dev",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
  ...
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "/datasets/ai-toolkit/models/Wan2.1-T2V-1.3B-Diffusers",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [false, false],
      "config.process[0].model.quantize_te": [true, false],
  ...
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "/datasets/ai-toolkit/models/Wan2.1-I2V-14B-480P-Diffusers",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
  ...
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "/datasets/ai-toolkit/models/Wan2.1-I2V-14B-720P-Diffusers",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
  ...
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "/datasets/ai-toolkit/models/Wan2.1-T2V-14B-Diffusers",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
  ...
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "/datasets/ai-toolkit/models/Wan2.2-T2V-A14B-Diffusers-bf16",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
    ...
    accuracyRecoveryAdapters: {
      ...
      "4 bit with ARA":
        "uint4|/datasets/studio/huggingface/models/accuracy_recovery_adapters/wan22_14b_t2i_torchao_uint4.safetensors",
    },
  },
  {
    name: "wan22_14b_i2v",
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "/datasets/ai-toolkit/models/Wan2.2-I2V-A14B-Diffusers-bf16",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
    ...
    accuracyRecoveryAdapters: {
      "4 bit with ARA":
        "uint4|/datasets/studio/huggingface/models/accuracy_recovery_adapters/wan22_14b_i2v_torchao_uint4.safetensors",
    },
  },
  {
    name: "wan22_5b",
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "/datasets/ai-toolkit/models/Wan2.2-TI2V-5B-Diffusers",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
  ...
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "/datasets/ai-toolkit/models/Qwen-Image",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
    ...
    accuracyRecoveryAdapters: {
      "3 bit with ARA":
        "uint3|/datasets/studio/huggingface/models/accuracy_recovery_adapters/qwen_image_torchao_uint3.safetensors",
    },
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "/datasets/studio/huggingface/models/Qwen-Image-2512",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
    ...
    accuracyRecoveryAdapters: {
      "3 bit with ARA":
        "uint3|/datasets/studio/huggingface/models/accuracy_recovery_adapters/qwen_image_2512_torchao_uint3.safetensors",
      "4 bit with ARA":
        "uint4|/datasets/studio/huggingface/models/accuracy_recovery_adapters/qwen_image_2512_torchao_uint4.safetensors",
    },
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "/datasets/T2ITrainer/models/Qwen-Image-Edit",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
    ...
    accuracyRecoveryAdapters: {
      "3 bit with ARA":
        "uint3|/datasets/studio/huggingface/models/accuracy_recovery_adapters/qwen_image_edit_torchao_uint3.safetensors",
    },
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "/datasets/studio/huggingface/models/Qwen-Image-Edit-2509",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
    ...
    accuracyRecoveryAdapters: {
      "3 bit with ARA":
        "uint3|/datasets/studio/huggingface/models/accuracy_recovery_adapters/qwen_image_edit_2509_torchao_uint3.safetensors",
    },
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "/datasets/studio/huggingface/models/Qwen-Image-Edit-2511",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
    ...
    accuracyRecoveryAdapters: {
      "3 bit with ARA":
        "uint3|/datasets/studio/huggingface/models/accuracy_recovery_adapters/qwen_image_edit_2511_torchao_uint3.safetensors",
    },
  },
  {
    ...
    defaults: {
      "config.process[0].model.name_or_path": [
        "/datasets/studio/huggingface/models/FireRed-Image-Edit-1.1",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
  ...
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "/datasets/studio/huggingface/models/FLUX.2-dev",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
  ...
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "/datasets/studio/huggingface/models/Z-Image",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
  ...
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "/datasets/studio/huggingface/models/Z-Image-De-Turbo",
        defaultNameOrPath,
      ],
      "config.process[0].model.extras_name_or_path": [
        "Tongyi-MAI/Z-Image-Turbo",
  ...
  },
  {
    ...
    defaults: {
      ...
      "config.process[0].model.assistant_lora_path": [
        "/datasets/ComfyUI/models/loras/minimax_h3_training_adapter_v1.safetensors",
        undefined,
      ],
...
└── vae/
  ...
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "/datasets/studio/huggingface/models/LTX-2",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
  ...
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "/datasets/studio/huggingface/models/LTX-2.3/ltx-2.3-22b-dev.safetensors",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
  ...
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "/datasets/studio/huggingface/models/FLUX.2-klein-base-4B",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
  ...
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "/datasets/studio/huggingface/models/ERNIE-Image",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
  ...
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "/datasets/studio/huggingface/models/FLUX.2-klein-base-9B",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
  ...
  },
  {
    ...
    defaults: {
      "config.process[0].model.name_or_path": [
        "/datasets/studio/huggingface/models/Nucleus-Image",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
  ...
  },
  {
    ...
    defaults: {
      "config.process[0].model.name_or_path": [
        "/datasets/studio/huggingface/models/ideogram-4-fp8",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
  ...
  },
  {
    ...
    defaults: {
      "config.process[0].model.name_or_path": [
        "/datasets/studio/huggingface/models/Krea-2-Raw",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
  ...
  },
  {
    ...
    defaults: {
      "config.process[0].model.name_or_path": [
        "/datasets/studio/huggingface/models/Krea-2-Turbo",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
      ...
      "config.process[0].model.low_vram": [true, false],
      "config.process[0].model.assistant_lora_path": [
        "/datasets/studio/huggingface/models/krea2_turbo_training_adapter/krea2_turbo_training_adapter_v1.safetensors",
        undefined,
      ],
      "config.process[0].sample.guidance_scale": [1, 4],
      "config.process[0].sample.sample_steps": [9, 25],
  ...
  },
  {
    ...
    defaults: {
      "config.process[0].model.name_or_path": [
        "/datasets/studio/huggingface/models/Boogu-Image-0.1-Base",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
  ...
  },
  {
    ...
    defaults: {
      "config.process[0].model.name_or_path": [
        "/datasets/studio/huggingface/models/Boogu-Image-0.1-Edit",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
