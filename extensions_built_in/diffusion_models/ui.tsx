...
export const AI_TOOLKIT_UI_MODELS: ModelArch[] = [
  ...
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "./models/Chroma1-Base/Chroma1-Base.safetensors",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
  ...
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "./models/Zeta-Chroma/zeta-chroma-base-x0-pixel-dino-distance.safetensors",
        defaultNameOrPath,
      ],
  ...
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "./models/Wan2.1-I2V-14B-480P-Diffusers",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
  ...
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "./models/Wan2.1-I2V-14B-720P-Diffusers",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
  ...
  },
  {
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "./models/Wan2.2-T2V-A14B-Diffusers-bf16",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
    ...
    accuracyRecoveryAdapters: {
      ...
      "4 bit with ARA":
        "uint4|./models/accuracy_recovery_adapters/wan22_14b_t2i_torchao_uint4.safetensors",
    },
  },
  {
    name: "wan22_14b_i2v",
    ...
    defaults: {
      // default updates when [selected, unselected] in the UI
      "config.process[0].model.name_or_path": [
        "./models/Wan2.2-I2V-A14B-Diffusers-bf16",
        defaultNameOrPath,
      ],
      "config.process[0].model.quantize": [true, false],
      "config.process[0].model.quantize_te": [true, false],
    ...
    accuracyRecoveryAdapters: {
      "4 bit with ARA":
        "uint4|./models/accuracy_recovery_adapters/wan22_14b_i2v_torchao_uint4.safetensors",
    },
  },
  {
    name: "wan22_5b",
  ...
  },
  {
    ...
    accuracyRecoveryAdapters: {
      "3 bit with ARA":
        "uint3|./models/accuracy_recovery_adapters/qwen_image_torchao_uint3.safetensors",
    },
  },
  {
    ...
    accuracyRecoveryAdapters: {
      "3 bit with ARA":
        "uint3|./models/accuracy_recovery_adapters/qwen_image_2512_torchao_uint3.safetensors",
      "4 bit with ARA":
        "uint4|./models/accuracy_recovery_adapters/qwen_image_2512_torchao_uint4.safetensors",
    },
  },
  {
    ...
    accuracyRecoveryAdapters: {
      "3 bit with ARA":
        "uint3|./models/accuracy_recovery_adapters/qwen_image_edit_torchao_uint3.safetensors",
    },
  },
  {
    ...
    accuracyRecoveryAdapters: {
      "3 bit with ARA":
        "uint3|./models/accuracy_recovery_adapters/qwen_image_edit_2509_torchao_uint3.safetensors",
    },
  },
  {
    ...
    accuracyRecoveryAdapters: {
      "3 bit with ARA":
        "uint3|./models/accuracy_recovery_adapters/qwen_image_edit_2511_torchao_uint3.safetensors",
    },
  },
  {
    name: "qwen_image_2",
  ...
  },
  {
    ...
    accuracyRecoveryAdapters: {
      "3 bit with ARA":
        "uint3|./models/accuracy_recovery_adapters/hidream_i1_full_torchao_uint3.safetensors",
    },
  },
  {
    name: "hidream_e1",
...
└── vae/
  ...
  },
  {
    ...
    defaults: {
      ...
      "config.process[0].train.guidance_loss_target": [3.5, undefined],
      "config.process[0].model.assistant_lora_path": [
        "./models/minimax_h3_training_adapter/minimax_h3_ref2va_training_adapter_v1.safetensors",
        undefined,
      ],
      "config.process[0].network.linear": [16, defaultLinearRank],
      "config.process[0].network.linear_alpha": [16, defaultLinearRank],
  ...
  },
  {
    ...
    defaults: {
      "config.process[0].model.name_or_path": [
        "./models/L2P/model-1k-merge.safetensors",
        defaultNameOrPath,
      ],
      "config.process[0].model.extras_name_or_path": [
        "./models/Z-Image-Turbo",
