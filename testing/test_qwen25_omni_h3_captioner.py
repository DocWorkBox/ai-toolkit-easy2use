...
MODEL_PATH = "./models/Qwen2.5-Omni-7B-H3-Prompt-Rewriter"
...
def test_qwen25_omni_h3_is_registered_and_uses_portable_local_default():
    ...
    assert "zhaoke1006/Qwen2.5-Omni-7B-H3-Prompt-Rewriter" not in section
