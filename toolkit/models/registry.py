...
ARCH_REGISTRY: Dict[str, dict] = {
    ...
    "qwen25_omni": {"modality": "text", "model": {"name_or_path": "/datasets/studio/huggingface/models/ai-tookit-Qwen2.5-Omni-7B/qwen2_5_omni_7b_convrot8.safetensors", "quantize": True, "qtype": "convrot8"}, "sample": {"width": 512, "height": 512, "num_inference_steps": 1, "guidance_scale": 1.0}},
    "yue2": {"modality": "audio", "model": {"name_or_path": "/datasets/studio/huggingface/models/YuE2/checkpoints/yue2_3b_int8_convrot.safetensors", "quantize": True, "qtype": "convrot8"}, "sample": {"width": 512, "height": 512, "num_inference_steps": 32, "guidance_scale": 1.0, "duration": 120}},
}
