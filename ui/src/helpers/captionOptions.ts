...
export const captionerTypes: CaptionOption[] = [
    ...
    },
    {
        ...
        group: 'music',
        defaults: {
            'config.process[0].caption.model_name_or_path': ['./models/MOSS-Music-8B-Instruct', defaultNameOrPath],
            'config.process[0].caption.extensions': [extensionsAudio, defaultExtensions],
            'config.process[0].caption.caption_format': ['ace_step', undefined],
        ...
        name_or_path_options: [
            { value: './models/MOSS-Music-8B-Instruct', label: './models/MOSS-Music-8B-Instruct' },
        ],
        captionPrompts: {
    ...
    },
    {
        ...
        defaults: {
            'config.process[0].caption.model_name_or_path': ['./models/Qwen2.5-Omni-7B-H3-Prompt-Rewriter', defaultNameOrPath],
    ...
    },
    {
        ...
        group: 'image/video/sound',
        defaults: {
            'config.process[0].caption.model_name_or_path': [
        ...
        name_or_path_options: [
            {
                value: './models/text_encoders/qwen3_omni_30b_a3b_instruct_thinker_convrot8.safetensors',
                label: 'Qwen3-Omni 30B A3B Instruct (ConvRot8)',
            },
            {
                value: './models/text_encoders/qwen3_omni_30b_a3b_thinking_convrot8.safetensors',
                label: 'Qwen3-Omni 30B A3B Thinking (ConvRot8)',
            },
            {
                value: './models/text_encoders/huihui_qwen3_omni_30b_a3b_thinking_abliterated_convrot8.safetensors',
                label: 'Huihui Qwen3-Omni 30B A3B Thinking Abliterated (ConvRot8)',
            },
        ],
        captionPrompts: {
            '通用': defaultVideoCaptionPrompt,
    ...
    },
    {
        ...
        cloudLoras: [
            {
                path: './models/loras/qwen2_5_omni_7b_lora_caption_this_song.safetensors',
                name: 'Caption This Song',
            },
        ],
        defaults: {
            'config.process[0].caption.loras': [[], undefined],
            'config.process[0].caption.model_name_or_path': ['./models/text_encoders/qwen2_5_omni_7b_convrot8.safetensors', defaultNameOrPath],
            'config.process[0].caption.extensions': [[...extensionsVideo, ...extensionsImage, ...extensionsAudio], defaultExtensions],
            'config.process[0].caption.caption_prompt': [defaultVideoCaptionPrompt, undefined],
            'config.process[0].caption.max_res': [512, undefined],
            'config.process[0].caption.max_new_tokens': [512, undefined],
        ...
        name_or_path_options: [
            { value: './models/text_encoders/qwen2_5_omni_7b_convrot8.safetensors', label: 'Qwen2.5-Omni 7B (ConvRot8)' },
            { value: './models/Qwen2.5-Omni-7B', label: './models/Qwen2.5-Omni-7B' },
            { value: './models/Qwen2.5-Omni-3B', label: './models/Qwen2.5-Omni-3B' },
        ],
        captionPrompts: {
            '通用': defaultVideoCaptionPrompt,
            'MiniMax H3 视频': minimaxT2VCaptionPrompt,
